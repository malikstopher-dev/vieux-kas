...
export const content = {
  en: {
    ...
    home: {
      ...
      geographyBody: "AKGLOBAL operates from Fourways, Sandton, in South Africa, supporting businesses in South Africa and the Democratic Republic of the Congo with their industrial supply requirements.",
    ...
    about: {
      ...
      sections: [
        ...
        ["Our base", "The company is registered and operates from Fourways, Sandton, South Africa. From this South African base, AKGLOBAL supports industrial supply requirements for businesses locally and in the Democratic Republic of the Congo."],
  ...
  fr: {
    ...
    meta: {
      ...
      procurement: ["Approvisionnement industriel", "Envoyez votre demande de prix, fiche technique ou liste d’achats pour une évaluation d’approvisionnement depuis l’Afrique du Sud."],
    ...
    home: {
      ...
      heroBody: "AKGLOBAL TRADING PTY fournit des équipements industriels, des solutions de levage, de la boulonnerie et des services d’approvisionnement professionnel aux entreprises en Afrique du Sud et en République démocratique du Congo.",
      imageCaption: "Conçu pour des exigences rigoureuses",
      supplyKicker: "01 / Notre offre",
      supplyTitle: "Vos besoins industriels. Approvisionnés avec précision.",
      ...
      geographyTitle: "Une base sud-africaine. Une portée régionale.",
      geographyBody: "AKGLOBAL opère depuis Fourways, Sandton, en Afrique du Sud, et accompagne des entreprises en Afrique du Sud ainsi qu’en République démocratique du Congo dans leurs besoins d’approvisionnement industriel.",
      ...
      steps: ["Envoyez votre demande", "Nous évaluons l’approvisionnement", "Recevez votre devis", "La fourniture est organisée"],
      ...
      reasons: ["Approvisionnement réactif", "Devis clairs", "Expertise produits industriels", "Communication professionnelle", "Service aux clients transfrontaliers", "Approvisionnement axé sur l’entreprise"],
    ...
    categories: [
      ...
      {key: "procurement", title: "Approvisionnement industriel", short: "Demandes de prix · Quantités · Besoins spéciaux", description: "Approvisionnement guidé par vos besoins pour les listes d’achats, produits spécifiés et demandes industrielles particulières.", items: ["Évaluation des demandes de prix", "Approvisionnement industriel", "Achats en quantité", "Besoins particuliers", "Fourniture aux entreprises"], route: "procurement"},
    ] satisfies CategoryContent[],
    about: {
      ...
      sections: [
        ["Notre rôle", "Nous partons des spécifications du client. Qu’il s’agisse d’un grade de fixation précis, d’un équipement de levage ou d’une liste d’achats complète, nous évaluons le besoin et préparons une offre commerciale en fonction des possibilités d’approvisionnement et de la disponibilité."],
        ["Notre base", "La société est enregistrée et opère depuis Fourways, Sandton, en Afrique du Sud. Depuis cette base sud-africaine, AKGLOBAL accompagne les besoins de fourniture industrielle des entreprises locales et en République démocratique du Congo."],
    ...
    procurement: {
      kicker: "Approvisionnement / Achats industriels",
      ...
      process: [
        ...
        ["02", "Évaluation de l’approvisionnement", "Nous évaluons les possibilités d’approvisionnement et la disponibilité selon la quantité et les conditions demandées."],
